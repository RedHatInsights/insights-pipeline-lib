        ...
        dir(pipelineVars.e2eDeployDir) {
            ...
            def builderTask = {
                ...
                sh(
                    ...
                    "${ocDeployerBuilderPath} -t buildfactory -e env/smoke.yml " +
                    "-e builder-env.yml ${project}"
                )
            }
            ...
            def serviceTask = {
                ...
                sh(
                    ...
                    "-e env/smoke.yml -e custom-env.yml ${project}"
                )
            }
...
private def allocateResourcesAndRun(
    ...
    lock(label: pipelineVars.smokeTestResourceLabel, quantity: 1, variable: "PROJECT") {
        ...
        openShiftUtils.withNode(
            image: pipelineVars.iqeTestsImage, namespace: env.PROJECT, envVars: envVars
        ) {
            runPipeline(
